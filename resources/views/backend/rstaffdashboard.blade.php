...
@section('title', 'Reservation Staff Dashboard')
    ...
    <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
      <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
        <div class="flex-grow-1 d-flex align-items-center">
          ...
          <div class="text">
            <h6 class="mb-0">Coming up Bookings</h6><span class="text-gray">{{ $comingupbookingcount }}</span>
          </div>
        </div>
    ...
    <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
      <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
        <div class="flex-grow-1 d-flex align-items-center">
          ...
          <div class="text">
            <h6 class="mb-0">Members</h6><span class="text-gray">{{ $membercount }}</span>
          </div>
        </div>
        <div class="icon text-white bg-blue"><i class="far fa-address-card"></i></div>
      </div>
    </div>
    <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
      <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
        <div class="flex-grow-1 d-flex align-items-center">
          ...
          <div class="text">
            <h6 class="mb-0">Guests</h6><span class="text-gray">{{ $guestcount }}</span>
          </div>
        </div>
        <div class="icon text-white bg-red"><i class="far fa-address-book"></i></div>
      </div>
    </div>
  </div>
</section>
