				    		...
				    		<tr>
				    			...
				    			<td>
				    				@if ($booking->status == "booked")
				    					<span class="badge badge-primary badge-pill text-capitalize">{{ $booking->status }}</span>
				    				...
				    				@elseif ($booking->status == "check out")
				    					<span class="badge badge-secondary badge-pill text-capitalize">{{ $booking->status }}</span>
				    				@elseif ($booking->status == "cancel")
				    					<span class="badge badge-danger badge-pill text-capitalize">{{ $booking->status }}</span>
				    				@endif
				    			</td>
				    			<td class="td-action">
