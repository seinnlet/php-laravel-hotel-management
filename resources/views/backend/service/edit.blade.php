...
@section('content')
	<section class="py-5">
		<div class="mb-4">
			<h5 class="title-heading d-inline-block float-left">Edit Service</h5>
      ...
      <div class="card-header">
        <h3 class="h6 mb-0">Edit {{ $service->name }}</h3>
      </div>
      <div class="card-body">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" name="name" id="name" placeholder="Enter Service Name" value="{{ old('name', $service->name) }}">
	          	@error('name')
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-md-9">
              <div class="input-group">
							  ...
							  <input type="number" class="form-control" name="unitcharge" id="unitcharge" min="0" placeholder="Enter Unit Charge" value="{{ old('unitcharge', $service->unitcharge) }}" step=".01">
							</div>
							@error('unitcharge')
					     	<div class="error-message text-danger pl-1 mt-1">
				     			<small>{{ $message }}</small>
